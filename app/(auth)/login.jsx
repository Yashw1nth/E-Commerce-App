...
export default function Login() {
  ...
  return (
    <View style={styles.container}>
      {/* Lottie Background from online URL */}
      <LottieView
        ...
        >
          <View style={styles.modalContainer}>
            <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
              ...
              <Text style={styles.modalMessage}>Redirecting to home...</Text>
            </Animated.View>
          </View>
        </Modal>
      </View>
...
const styles = StyleSheet.create({
  ...
  lottieBackground: {
    width,
    height: height / 2.5, // Adjust height to occupy top portion
    position: "absolute",
    top: 10,
    left: 0,
  },
  ...
  button: { backgroundColor: "#166bc6ff", padding: 12, borderRadius: 8, alignItems: "center", marginTop: 10, width: "100%" },
